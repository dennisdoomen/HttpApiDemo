...
class Build : NukeBuild
{
    ...
    Target RunInspectCode => _ => _
        ...
        .Executes(() =>
        {
            InspectCode($"HttpApiDemo.sln -o={ArtifactsDirectory / "CodeIssues.sarif"} --no-build");
        });
    ...
    Target RunTests => _ => _
        ...
        .Executes(() =>
        {
            ...
            var project = Solution.GetProject("HttpApiDemo.Specs");
    ...
    Target ApiChecks => _ => _
        ...
        .Executes(() =>
        {
            var project = Solution.GetProject("HttpApiDemo.ApiVerificationTests");
    ...
    Target Pack => _ => _
        ...
        .Executes(() =>
        {
            ...
            DotNetPack(s => s
                .SetProject(Solution.GetProject("HttpApiDemo"))
